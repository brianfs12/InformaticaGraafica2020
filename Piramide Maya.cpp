...
void MainBody(glm::vec3 bodyPos, Shader ourShader, int type);
...
int main()
{
    ...
    unsigned char* data = stbi_load("arena.jpg", &width, &height, &nrChannels, 0);
    if (data)
    {
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // MAIN BODY
        MainBody(castle, ourShader, 10);
        MainBody(castle, ourShader, 9);
        MainBody(castle, ourShader, 8);
        MainBody(castle, ourShader, 7);
        MainBody(castle, ourShader, 6);
        MainBody(castle, ourShader, 5);
        MainBody(castle, ourShader, 4);
        MainBody(castle, ourShader, 3);
        MainBody(castle, ourShader, 2);
        MainBody(castle, ourShader, 1);
        MainBody(castle, ourShader, 0);
...
void MainBody(glm::vec3 bodyPos, Shader ourShader,int type) {
    ...
    for (unsigned int i = 0; i < 10; i++)
    {
        ...
        model = glm::translate(model, glm::vec3(bodyPos.x, Ypos + 0.4f, bodyPos.z));
        model = glm::scale(model, glm::vec3(mS, height, mS));
